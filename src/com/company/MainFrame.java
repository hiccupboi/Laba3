...
// Отцентрировать окно приложения на экране. Задаѐт положение верхнего левого угла
//компонента относительно верхнего левого
//угла компонента-контейнера
...
// сохранить данные в двоичный файл
        ...
        Action aboutAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
// Показать диалоговое окно
                JOptionPane.showMessageDialog(MainFrame.this, "Денис Шулимов");
            }
        };
...
// Запросить пользователя ввести искомую строку
                String value =
                        JOptionPane.showInputDialog(MainFrame.this, "Введите значение для поиска", "Поиск значения", JOptionPane.QUESTION_MESSAGE);
